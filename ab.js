! function(r, e, t, n, i, o, a, s) {
    ...
    window.AB || d("disable_abtestingai") || (window.AB = window.AB || {
        converted: function() {
            ...
            t.withCredentials = !0, t.open("POST", "https://abtestai1.ga/visitor_converted/", !0), t.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), t.send(encodeURI("url=" + window.location.href + "&uuid=" + e))
        }
    ...
    }), localStorage.setItem("abtesting.ai-uuid", o)), a = d("abtestingai_ab_test_id"), s = d("utm_term") || d("hsa_kw") || d("keyword"), scripts.push("https://abtestai1.ga/fetch_variant/?width=" + i + "&url=" + encodeURIComponent(window.location.href) + "&referrer=" + encodeURIComponent(document.referrer) + "&uuid=" + encodeURIComponent(o) + "&ab_test_id=" + (a ? encodeURIComponent(a) : "") + "&utm_term=" + (s ? encodeURIComponent(s) : "") + "&url_params=" + encodeURIComponent(location.search)), function(e, t, n, i, o) {
        function a(e) {
